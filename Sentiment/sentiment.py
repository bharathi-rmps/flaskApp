...
def predict_audio():
    ...
    if src_lang == "English" and trg_lang == "Tamil":
        ...
        sp_trg_path = "ta"
        out_language = "ta"
        folder = "tf_model/5Lang/English to Tamil"
    elif src_lang == "Tamil" and trg_lang == "English":
        in_language = 'ta-in'
        sp_src_path = "ta"
        sp_trg_path = "en"
        out_language = "en"
        folder = "tf_model/5Lang/Tamil to English"
    elif src_lang == "Spanish" and trg_lang == "Turkish":
        in_language = 'es'
        sp_src_path = "es"
        sp_trg_path = "tr"
        out_language = "tr"
        folder = "tf_model/5Lang/Spanish to Turkish"
    elif src_lang == "Hindi" and trg_lang == "English":
        in_language = 'hi-in'
        sp_src_path = "hi"
        sp_trg_path = "en"
        out_language = "en"
        folder = "tf_model/5Lang/Hindi to English"
    elif src_lang == "English" and trg_lang == "Hindi":
        in_language = 'en-in'
        sp_src_path = "en"
        sp_trg_path = "hi"
        out_language = "hi"
        folder = "tf_model/5Lang/English to Hindi"
